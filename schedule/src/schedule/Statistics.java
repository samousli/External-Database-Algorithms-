...
public class Statistics {
    ...
    /**
     * The time since the arrival of the process and the first time it got CPU
     * time.
     */
     ...
     * @return the average response time = sum of response time of every process
     * / number of processes
     */
     ...
     *
     * for still waiting processes : [sum of every process(current time -
     * (arrival time + CPU time))] where CPU time is the total time the process
     * spent in the CPU and is calculated as: total CPU time - remaining CPU
     * time
     *
     * for terminated processes : sum of every process(termination time -
     * (arrival time + burst time))
     *
     * finally average waiting time = the sum of these two values / size where
     * size if the sum of the number of the two lists
     */
     ...
     * @param terminatedProcesses is the list containing the terminated
     * processes
     */
